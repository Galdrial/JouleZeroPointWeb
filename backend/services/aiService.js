...
DATABASE_LIVE: Attualmente sono censite ${totalCards} frequenze (carte) nel database attivo.`;
    } else {
        sessionInstruction = `L'utente attuale è un "Ospite Esterno" non autenticato. Se ti chiede chi è, rispondi direttamente che non puoi asseverar la sua identità digitale finché non effettua il login nel sistema Punto Zero.
